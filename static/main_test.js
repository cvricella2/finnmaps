...
require([
  ...
  // Below is all DOM events for the editing widget
    ...
    placeTypeInput.addEventListener("click",function(){
      placeTypeDropdown.style.display = "flex";
    ...
    for (let key in placeTypeConfig) {
      ...
      aTag.href = "#"
      aTag.className = "placeTypeOption"
      aTag.innerHTML = key
      placeTypeDropdown.appendChild(aTag);
      aTag.addEventListener("click",function(){
        let placeTypeHTML = aTag.innerHTML;
        placeTypeVal = `${placeTypeConfig[placeTypeHTML]}`;
        placeTypeDropdown.style.display="none";
        // dropdownContainer.style.display = "none";
        placeTypeInput.value = placeTypeHTML;
      });
    };
