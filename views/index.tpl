...
<html>
  <head>
    ...
    <link rel="stylesheet"  type="text/css" href="finnmaps/static/main.css?version=1.0"></link>
    <script type="text/javascript" src="https://js.arcgis.com/4.17/"></script>
    <script type="text/javascript" src="finnmaps/static/main.js?version=1.0"></script>
  ...
  <body>
    ...
    <form name = "submitForm" method="post" action="/">
      <div class ="formContainer" id ="signupWidget">
        ...
        <button type ="button" class="finnMapBtn" id="submitFormBtn">Submit</button>
    ...
    <form name = "editForm" method="post" action="/">
      <div class = "formContainer" id ="editWidget">
        ...
        <h3> Suggest a Place for Finn to Visit </h3>
        ...
        <select id="placeTypeList" name="placeTypeList" class="dropdown">
         <option value=""selected> </option>
         <option value="1">Village Park</option>
         <option value="2">Town Park</option>
         <option value="3">County Park</option>
         <option value="4">State Park</option>
         <option value="5">National Park</option>
         <option value="6">Preserve</option>
         <option value="7">Eatery</option>
